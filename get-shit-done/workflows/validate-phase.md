...
```
Task(
  prompt="Read /Users/tuomasleppanen/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/tuomasleppanen/.claude/get-shit-done/templates/VALIDATION.md`
